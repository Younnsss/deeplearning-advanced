...
def main():
    ...
    # 1) VAD
    run(f"{PYTHON} TP3/vad_segment.py")
    vad = load_json("TP3/outputs/vad_segments_call_01.json")

    # 2) ASR
    run(f"{PYTHON} TP3/asr_whisper.py")
    asr = load_json("TP3/outputs/asr_call_01.json")

    # 3) Analytics
    run(f"{PYTHON} TP3/callcenter_analytics.py")
